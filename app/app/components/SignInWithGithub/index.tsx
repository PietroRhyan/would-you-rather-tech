...
export function SignInWithGithub() {
  ...
  return (
    <>
      { loggedIn ? (
        <div className="hidden md:flex items-center justify-center gap-3 text-sm text-white">
        ...
        <div className="hidden md:flex items-center justify-center p-[1px] rounded-xl bg-gradient-to-r from-red to-blue">
